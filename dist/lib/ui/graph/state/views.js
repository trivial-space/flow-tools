...
export var entityWindowProps = stream([entityWindow.HOT, activeNode.HOT, activeWindow.HOT], function (dimensions, node, window) { return ({ dimensions: dimensions, node: node, window: window }); }).val({});
